...
blackArrayStandard = ['path6367','path106','path1154','path7109','defrostControlWiper'];
blueArrayStandard = ['path6357','path328','path1118','path1120','path7069','path7071','path7073','path7075','path7077','defrostThermostat1Blade','defrostThermostat2Blade','path1470'];
orangeArrayStandard = ['path6996'];
...
function checkAnswer(){
  ...
  if(defrostThermostat1BladeRotated === true){
    answerArray.push("false")
  }

  if(defrostThermostat2BladeRotated === true){
    answerArray.push("false")
  }
...
imvSwitch.setAttribute('onclick','changewaterValveSwitch();');
imvSwitch.setAttribute('onmouseover','this.style.cursor = "pointer";');
function changewaterValveSwitch(){
  console.log('fires')
...
var defrostThermostat1BladeRotated=false;
defrostThermostat.setAttribute('onclick','changedefrostThermostat1Blade();');
defrostThermostat.setAttribute('onmouseover','this.style.cursor = "pointer";');
function changedefrostThermostat1Blade(){
  console.log('fires')
	if(defrostThermostat1BladeRotated === false){
		TweenMax.to(defrostThermostat1Blade,1,{rotation:40});
		TweenMax.to(defrostThermostat1Bladecopy,1,{rotation:40});
		defrostThermostat1BladeRotated=true;
	}else{
		TweenMax.to(defrostThermostat1Blade,1,{rotation:0});
		TweenMax.to(defrostThermostat1Bladecopy,1,{rotation:0});
		defrostThermostat1BladeRotated=false;
	}
}

var defrostThermostat2BladeRotated=false;
defrostThermostat2.setAttribute('onclick','changedefrostThermostat2Blade();');
defrostThermostat2.setAttribute('onmouseover','this.style.cursor = "pointer";');
function changedefrostThermostat2Blade(){
  console.log('fires')
	if(defrostThermostat2BladeRotated === false){
		TweenMax.to(defrostThermostat2Blade,1,{rotation:40});
		TweenMax.to(defrostThermostat2Bladecopy,1,{rotation:40});
		defrostThermostat2BladeRotated=true;
	}else{
		TweenMax.to(defrostThermostat2Blade,1,{rotation:0});
		TweenMax.to(defrostThermostat2Bladecopy,1,{rotation:0});
		defrostThermostat2BladeRotated=false;
	}
}
