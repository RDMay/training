...
TweenMax.to([gear1], 5, {rotation:360, transformOrigin: "50% 50%", ease: Power0.easeNone, repeat:-1});
TweenMax.to([gear2], 5, {rotation:-360, transformOrigin: "50% 50%", ease: Power0.easeNone, repeat:-1});
TweenMax.to([gear3], 5, {rotation:360, transformOrigin: "50% 50%", ease: Power0.easeNone, repeat:-1});
TweenMax.to([path2185], 5, {autoAlpha:1, ease: Power0.easeNone, repeat:-1});
