...
blackArrayStandard = ['path6367','path106','path262','path6970','path1154','path7014','defrostControlWiper','tcBlade'];
blueArrayStandard = ['path6357','path7016','path7069','path7071','path7073','path7075'];
orangeArrayStandard = ['path146'];
