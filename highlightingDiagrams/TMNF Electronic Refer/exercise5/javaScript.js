document.title = "TM Refrigerator Exercise 5"
...
blackArrayStandard = ['path6367','path106','path1154'];
blueArrayStandard = ['path6357','path6361','path7069','path7071','path7073','path7075','path7077','path7079'];
