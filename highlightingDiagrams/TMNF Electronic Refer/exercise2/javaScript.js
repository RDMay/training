...
l1ArrayKey = ['path6367','path106','path262','path6970','path1154','path7010','path7018','path7060','defrostControlWiper','tcBlade'];
neutralArrayKey = ['path6357','path7020','path7069','path7071'];
energizedLoadArrayKey = ['path150'];
dcPlusArrayKey = [];
dcMinusArrayKey = [];
rpmFeedBackArrayKey = [];
