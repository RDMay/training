document.title = "TMNF Highlight Exercise 3"
...
l1ArrayKey = ['path3064','path2783','path182','path2775','path6641','path9983','waterValveSwitch','path3066'];
neutralArrayKey = ['path1116','path6617'];
energizedLoadArrayKey = ['path3913'];
dcPlusArrayKey = [];
dcMinusArrayKey = [];
rpmFeedBackArrayKey = [];
