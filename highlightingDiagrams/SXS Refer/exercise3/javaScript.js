document.title = "SXS Electronic Highlight Exercise 3"
...
l1ArrayKey = ['path410','path46206','path4776','path4797','path2233','path2241','heaterRelay','path2371','path2387'];
neutralArrayKey = ['path392','path1339','path3380','highLimitSwitch','path4766','path4783','path1341'];
energizedLoadArrayKey = ['path4781'];
dcPlusArrayKey = [];
dcMinusArrayKey = [];
rpmFeedBackArrayKey = [];
