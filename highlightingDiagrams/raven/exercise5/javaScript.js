document.title = "TMNF Highlight Exercise 5"
...
l1ArrayKey = ['path2783','path1077','path2801','path2691','path178-2','path2775','path1097','path1100','path162-5','timerSwitch','ccSwitch'];
neutralArrayKey = ['path1117','path1116','path1099'];
